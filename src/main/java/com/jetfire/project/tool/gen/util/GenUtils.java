package com.jetfire.project.tool.gen.util;

import java.util.ArrayList;
import java.util.List;
import org.apache.velocity.VelocityContext;
import com.jetfire.common.constant.Constants;
import com.jetfire.common.constant.CommonMap;
import com.jetfire.common.utils.DateUtils;
import com.jetfire.common.utils.StringUtils;
import com.jetfire.framework.config.GenConfig;
import com.jetfire.project.tool.gen.domain.ColumnInfo;
...
{
    /** 项目空间路径 */
    private static final String projectPath = "main/java/com/jetfire/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.jetfire.project.system"));
    }
}
